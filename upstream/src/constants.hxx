...
// Human controls black when AI is disabled (sandbox / two-seat stream)
const int BLACK_TURN = 5;
const int BLACK_MOVING = 6;
const int GAME_OVER = 7;

/* How the game ended (only meaningful when state == GAME_OVER). */
const int END_NONE = 0;
const int END_CHECKMATE = 1;
const int END_FORFEIT = 2;
